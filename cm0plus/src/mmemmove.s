...
@ returns destination addr in r0
  ...
  push  {r4, r5, r6}          @ store r4 & r5 values on stack
  beq   exit              @ exit
...
quad_word_b_copy:
  subs    r3, r3, #16
  subs    r4, r4, #16
  ldr     r5, [r3, #12]     @ load word from memory[r3-4] into r5
  str     r5, [r4, #12]     @ store r5 word into memory[r4-4]
  ldr     r5, [r3, #8]
  str     r5, [r4, #8]
  ldr     r5, [r3, #4]
  str     r5, [r4, #4]
  ldr     r5, [r3]
  str     r5, [r4]
  subs    r2, r2, #16       @ decrement remaining bytes by 4
  cmp     r2, #16           @ check if there are 16 or more bytes to copy
